// ============================================================================
// N-body 3D - Step 03: replace pow() with sqrt + multiplications
// ----------------------------------------------------------------------------
// pow(d2, 3/2) is a very expensive library call. Since d2^(3/2) == d^3 where
// d = sqrt(d2), we replace it with one sqrt and two multiplications.
// ============================================================================
#include <omp.h>
#include <math.h>
#include <stdio.h>
