// ============================================================================
// N-body 3D - Step 02: + restrict
// ----------------------------------------------------------------------------
// Same SoA + aligned layout as step 01, with the `restrict` qualifier added to
// every pointer. It promises the compiler the arrays never alias, unlocking
// more aggressive vectorization and instruction scheduling.
// ============================================================================
#include <omp.h>
#include <math.h>
#include <stdio.h>
...
void init_particles(particles_t *restrict p, u64 n) {
  for (u64 i = 0; i < n; i++) {
    u64 r1 = (u64)rand();
    u64 r2 = (u64)rand();
    f32 sign = (r1 > r2) ? 1 : -1;
...
void move_particles(particles_t *restrict p, const f32 dt, u64 n) {
